...
export const METRIC_TIME = 'time';
export const METRIC_ELEVATION = 'elevation';
export const METRIC_PACE = 'pace';
...
export const CYCLING_METRICS = [METRIC_DISTANCE, METRIC_TIME, METRIC_ELEVATION];

export const RUNNING_METRICS = CYCLING_METRICS.concat([METRIC_PACE]);

// export const CYCLING_METRICS =
//   METRIC_DISTANCE,
//   METRIC_MOVING_TIME,
//   METRIC_ELAPSED_TIME,
...
mapMetricLabel[METRIC_TIME] = 'Moving time';
mapMetricLabel[METRIC_ELEVATION] = 'Elevation gain';
mapMetricLabel[METRIC_PACE] = 'Pace';
...
export const TIME_FRAME_DAYS = [10, 30, 60, 90, 120, 150, 180, 360];
